...
module test_Hu_rgb2gray_9_0_600_1024_1_2_2_Pipeline_columnloop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
test_Hu_mul_mul_8ns_14ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 14 ),
    .dout_WIDTH( 22 ))
mul_mul_8ns_14ns_22_4_1_U52(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_153_p0),
    .din1(grp_fu_153_p1),
...
test_Hu_mac_muladd_8ns_12ns_22ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
...
test_Hu_mac_muladd_8ns_15ns_22ns_23_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_1_reg_188 <= {{img_0_data64_dout[15:8]}};
        p_2_reg_193 <= {{img_0_data64_dout[23:16]}};
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        img_0_data64_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        img_0_data64_read = 1'b1;
    end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((img_1_data65_full_n == 1'b0) & (ap_enable_reg_pp0_iter6 == 1'b1)) | ((img_0_data64_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((img_1_data65_full_n == 1'b0) & (ap_enable_reg_pp0_iter6 == 1'b1)) | ((img_0_data64_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((img_1_data65_full_n == 1'b0) & (ap_enable_reg_pp0_iter6 == 1'b1)) | ((img_0_data64_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (img_0_data64_empty_n == 1'b0);
end
...
always @ (*) begin
    ap_block_state7_pp0_stage0_iter6 = (img_1_data65_full_n == 1'b0);
end
...
assign img_1_data65_din = {{grp_fu_168_p3[22:15]}};

assign j_V_2_fu_95_p2 = (ap_sig_allocacmp_j_V_1 + 11'd1);

assign p_fu_106_p1 = img_0_data64_dout[7:0];

endmodule //test_Hu_rgb2gray_9_0_600_1024_1_2_2_Pipeline_columnloop
