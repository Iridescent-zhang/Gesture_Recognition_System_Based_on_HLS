...
module CAL_Hu_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
CAL_Hu_mul_mul_8ns_14ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 14 ),
...
CAL_Hu_mac_muladd_8ns_12ns_22ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
...
CAL_Hu_mac_muladd_8ns_15ns_22ns_23_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
assign j_V_2_fu_95_p2 = (ap_sig_allocacmp_j_V_1 + 10'd1);

assign p_fu_106_p1 = img_0_data14_dout[7:0];

endmodule //CAL_Hu_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop
