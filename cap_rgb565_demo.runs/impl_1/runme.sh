...
HD_PWD='D:/Program_File/HLS_Files/cap_rgb565_demo/cap_rgb565_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sys_design_wrapper.tcl -notrace
