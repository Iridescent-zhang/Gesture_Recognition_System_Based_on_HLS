...
HD_PWD='D:/Program_File/HLS_Files/cap_rgb565_demo/cap_rgb565_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_design_wrapper.tcl
