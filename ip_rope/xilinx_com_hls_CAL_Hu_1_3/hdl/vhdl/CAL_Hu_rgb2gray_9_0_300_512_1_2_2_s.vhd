...
entity CAL_Hu_rgb2gray_9_0_300_512_1_2_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of CAL_Hu_rgb2gray_9_0_300_512_1_2_2_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_idle : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_ready : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_0_data14_read : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_write : STD_LOGIC;
    signal grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg : STD_LOGIC := '0';
    ...
    signal i_V_2_fu_88_p2 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    component CAL_Hu_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66 : component CAL_Hu_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start,
        ap_done => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done,
        ap_idle => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_idle,
        ap_ready => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_ready,
        ...
        img_0_data14_read => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_0_data14_read,
        img_1_data15_din => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_din,
        img_1_data15_num_data_valid => ap_const_lv2_0,
        img_1_data15_fifo_cap => ap_const_lv2_0,
        img_1_data15_full_n => img_1_data15_full_n,
        img_1_data15_write => grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_write,
        width => width_reg_106);
    ...
    grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg <= ap_const_logic_0;
            else
                if (((icmp_ln5500_fu_83_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_ready = ap_const_logic_1)) then 
                    grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_empty_n, p_src_cols_empty_n, grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done, ap_CS_fsm_state2, icmp_ln5500_fu_83_p2, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done)
    begin
        if ((grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_done = ap_const_logic_0)) then 
    ...
    grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start <= grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_ap_start_reg;
    i_V_2_fu_88_p2 <= std_logic_vector(unsigned(i_V_fu_50) + unsigned(ap_const_lv9_1));
    icmp_ln5500_fu_83_p2 <= "1" when (i_V_fu_50 = height_reg_111) else "0";

    img_0_data14_read_assign_proc : process(grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_0_data14_read, ap_CS_fsm_state3)
    begin
    ...
    img_1_data15_write_assign_proc : process(grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            img_1_data15_write <= grp_rgb2gray_9_0_300_512_1_2_2_Pipeline_columnloop_fu_66_img_1_data15_write;
        else 
