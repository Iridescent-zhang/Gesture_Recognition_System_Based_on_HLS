...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CLOCK_CMOS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "CMOS_FRAME_WAITCNT" -parent ${Page_0}


}

proc update_PARAM_VALUE.CLOCK_CMOS { PARAM_VALUE.CLOCK_CMOS } {
	# Procedure called to update CLOCK_CMOS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CLOCK_CMOS { PARAM_VALUE.CLOCK_CMOS } {
	# Procedure called to validate CLOCK_CMOS
	return true
}
...
proc update_MODELPARAM_VALUE.CLOCK_CMOS { MODELPARAM_VALUE.CLOCK_CMOS PARAM_VALUE.CLOCK_CMOS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CLOCK_CMOS}] ${MODELPARAM_VALUE.CLOCK_CMOS}
}
